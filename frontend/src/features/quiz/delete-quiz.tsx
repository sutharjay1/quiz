...
const DeleteQuiz = () => {
	...
	return (
		<Card className="flex flex-col w-full items-start justify-start rounded-lg bg-sidebar shadow-lg pt-6">
			<CardHeader className=" pt-6 pb-0 ">
				<CardTitle className="text-2xl font-semibold text-red-600 w-fit flex items-start justify-start">
					Danger Zone
				</CardTitle>
			</CardHeader>
			...
			<CardContent className="w-full space-y-2 pt-0">
				<div>
					...
					<P className="text-sm text-muted-foreground mt-2">
						Permanently remove your quiz and all of its contents
						from the response platform. This action is not
						reversible — please continue with caution.
					</P>
				</div>
			</CardContent>

			<CardFooter className="pt-0 w-full flex items-center justify-start space-x-4">
				<Button
					variant="destructive"
					className="w-fit   "
